...
//        UserProfile Create(UserProfile user, string password);
//        void Update(UserProfile user, string password = null);
//        void Delete(int id);
//    }
...
//        public UserProfile Create(UserProfile user, string password)
//        {
//            // validation
...
//        public void Update(UserProfile userParam, string password = null)
//        {
