      ...
      <>
        <Modal isOpen={true}>
          <form onSubmit={this.handleSubmit} className="form-horizontal">
            ...
            <ModalBody>
                <p>You are deleting product - {name}. Product`s category - {category}.</p>
            </ModalBody>
            <ModalFooter>
              <Button color="primary" onClick={this.handleSubmit} className="btn btn-primary">Delete</Button>
              <Button color="danger" onClick={this.props.cancelDeleteProduct} >Cansel</Button>
            </ModalFooter>
          </form>
        </Modal>
